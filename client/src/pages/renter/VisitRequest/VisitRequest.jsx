  ...
  const getVisitRequestData = async () => {
    try {
      const response = await fetch(
        `${serverapiUrl}/visitBooking/renterVisit/${user._id}`,
        {
          method: "GET",
          headers: {
      ...
      const events = visitRequestsData.map((visit) => ({
        ...
        ownerName: `${visit.ownerId.userName}`,
        ownerMobileNo: `${visit.ownerId.mobileNo}`,
        ownerEmailId: `${visit.ownerId.email}`,
                    ...
                    primary={
                      <>
                        ...
                        <Typography
                          ...
                          fontWeight="bold"
                        >
                          Owner: {visit.extendedProps.ownerName}
                        </Typography>
                        <Typography
                          variant="h6"
                          color={customColors.black}
